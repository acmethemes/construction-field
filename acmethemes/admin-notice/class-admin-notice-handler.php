	...
	public function getting_started() {
        ...
        <div id="at-gsm" class="updated notice-info at-gsm">
            ...
            <div class="at-gsm-container">
                <img class="at-gsm-screenshot" src="<?php echo esc_url(get_template_directory_uri().'/screenshot.jpg' )?>" alt="<?php esc_attr_e( 'Construction Field', 'construction-field' ); ?>" />
                <div class="at-gsm-notice">
                    ...
                    <a class="at-gsm-btn button button-primary button-hero" href="#" data-name="" data-slug="" aria-label="<?php esc_attr_e( 'Get started with Construction Field', 'construction-field' ); ?>">
